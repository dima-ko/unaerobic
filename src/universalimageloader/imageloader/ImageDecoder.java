...
/**
 * Decodes images to {@link android.graphics.Bitmap}
 *
...
final class ImageDecoder {
	...
	/**
	 * Decodes image from URL into {@link android.graphics.Bitmap}. Image is scaled close to incoming {@link ImageSize image size} during
